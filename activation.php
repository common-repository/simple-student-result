...
if(empty($row)){
   ...
   $wpdb->query("ALTER TABLE ".$wpdb->prefix.SSR_TABLE." ADD c2 text NULL");
	...
	if (strlen(esc_attr( get_option('ssr_settings_ssr_item16') ))==0) update_option('ssr_settings_ssr_item16','Extra Field 1');
	if (strlen(esc_attr( get_option('ssr_settings_ssr_item17') ))==0) update_option('ssr_settings_ssr_item17','Extra Field 2');
	if (strlen(esc_attr( get_option('ssr_settings_ssr_item18') ))==0) update_option('ssr_settings_ssr_item18','Extra Field 3');
	if (strlen(esc_attr( get_option('ssr_settings_ssr_item19') ))==0) update_option('ssr_settings_ssr_item19','Extra Field 4');
	if (strlen(esc_attr( get_option('ssr_settings_ssr_item20') ))==0) update_option('ssr_settings_ssr_item20','Extra Field 5');
	if (strlen(esc_attr( get_option('ssr_settings_ssr_item21') ))==0) update_option('ssr_settings_ssr_item21','Extra Field 6');
